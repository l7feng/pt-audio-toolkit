# jianying-draft-toolkit build entry (thin wrapper around tools/build.py).
#
...
# (<out-root>\pt-audio-toolkit-v<version>-<date>\jianying-draft-toolkit\)
# instead of packaging\dist\. tools\jy-draftc\ is copied next to the exe
# automatically; tkinterdnd2 flags are applied by tools/build.py.
...
python $builder jianying-draft-toolkit @args
exit $LASTEXITCODE
